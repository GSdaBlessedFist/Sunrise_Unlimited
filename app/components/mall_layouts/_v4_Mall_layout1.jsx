...
const firstFloorTexture = useTexture('/textures/mall-carpet(grey-white-squares).png')
  ...
  return (
    <group {...props} dispose={null}>
      <group name="Scene">
        ...
        <PerspectiveCamera ref={entryCameraRef} name="entry_Camera" makeDefault={true} far={1000} near={0.1} fov={30} position={[0, 1.829, 20]} rotation={[-0.084, 0, 0]} />
        <spotLight intensity={20} angle={0.454} penumbra={0.686} decay={2} position={[-2.406, -0.722, -3.848]} rotation={[-Math.PI / 2, 0, -0.262]} scale={[0.425, 0.425, 0.465]} target={nodes.Spot001.target}>
          <primitive object={nodes.Spot001.target} position={[0, 0, -1]} />
        </spotLight>
        <spotLight intensity={27} angle={0.436} penumbra={0.15} decay={2} position={[2.764, -0.722, -3.848]} rotation={[-Math.PI / 2, 0, 0]} target={nodes.Spot002.target}>
          <primitive object={nodes.Spot002.target} position={[0, 0, -1]} />
        </spotLight>
        <spotLight intensity={27} angle={0.436} penumbra={0.15} decay={2} position={[-2.406, -0.722, 1.055]} rotation={[-Math.PI / 2, 0, 0]} target={nodes.Spot003.target}>
        ...
        <spotLight intensity={53} angle={0.528} penumbra={0.15} decay={2} position={[8.386, 3.19, -0.708]} rotation={[-0.697, 0.62, -0.401]} target={nodes.Spot.target}>
        ...
        <group name="mall_floor_firstFloor">
          ...
          <mesh name="mall_floor_main" geometry={nodes.mall_floor_main.geometry}  >
            <meshStandardMaterial map={firstFloorTexture} attach="material" roughness={0.868}
        metalness={0}/>
          </mesh>
          <mesh name="mall_floor_main_1" geometry={nodes.mall_floor_main_1.geometry} material={materials.mall_wall_basic} />
          <mesh name="mall_floor_main_2" geometry={nodes.mall_floor_main_2.geometry} material={materials.mall_floor_sides} />
        </group>
