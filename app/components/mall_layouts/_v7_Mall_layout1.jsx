  ...
  return (
    <group {...props} dispose={null}>
      <group name="Scene">
        ...
        <PerspectiveCamera name="big-screens_Camera" makeDefault={false} far={1000} near={0.1} fov={33.166} position={[-10.811, -0.406, 1.278]} rotation={[2.915, -0.194, 3.097]} />
        <PerspectiveCamera ref={entryCameraRef} name="entry_Camera" makeDefault={true} far={1000} near={0.1} fov={22.895} position={[-0.003, 1.629, 21.758]} />
        <group name="stairs">
